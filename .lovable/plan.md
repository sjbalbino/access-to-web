...
4. **Reconciliar a nota 58966**: após o ajuste, usar "Buscar por chave" nessa nota para trazer o nome do emitente e confirmar a manifestação registrada na SEFAZ. Se a SEFAZ responder que não há manifestação, basta manifestar novamente — agora o status será persistido.
