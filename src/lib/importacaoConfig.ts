...
export const tableConfigs: TableConfig[] = [
  ...
  },
  {
    ...
    references: [
      ...
      { dbColumn: '_lavoura_codigo', sourceColumn: 'lavoura_codigo', lookupTable: 'lavouras', lookupColumn: 'codigo', lookupLabel: 'nome', required: true },
      { dbColumn: 'granja_id', sourceColumn: 'granja_codigo', lookupTable: 'granjas', lookupColumn: 'codigo', lookupLabel: 'razao_social', required: true, sourceColumnAliases: ['granja', 'codigo_granja', 'cod_granja', 'granjacodigo'] },
    ],
  },
  {
    key: 'clientes',
  ...
  },
  {
    ...
    references: [
      { dbColumn: '_granja_id', sourceColumn: 'granja_codigo', lookupTable: 'granjas', lookupColumn: 'codigo', lookupLabel: 'razao_social', required: true, sourceColumnAliases: ['granja', 'codigo_granja', 'cod_granja', 'granjacodigo'] },
  ...
  {
    key: 'remessas',
    label: 'Remessas de Venda',
    tableName: 'remessas_venda',
    description: 'Remessas vinculadas aos contratos de venda',
    order: 14,
    dependsOn: ['contratos', 'silos', 'placas', 'produtos'],
    columns: [
      { accessName: 'codigo', dbName: 'codigo', transform: toInt },
      { accessName: 'data_remessa', dbName: 'data_remessa', required: true, transform: toDate },
      { accessName: 'peso_bruto', dbName: 'peso_bruto', transform: toNumber },
      { accessName: 'peso_tara', dbName: 'peso_tara', transform: toNumber },
      { accessName: 'peso_liquido', dbName: 'peso_liquido', transform: toNumber },
      { accessName: 'ph', dbName: 'ph', transform: toNumber },
      { accessName: 'umidade', dbName: 'umidade', transform: toNumber },
      { accessName: 'impureza', dbName: 'impureza', transform: toNumber },
      { accessName: 'kg_remessa', dbName: 'kg_remessa', transform: toNumber },
      { accessName: 'kg_desconto_umidade', dbName: 'kg_desconto_umidade', transform: toNumber },
      { accessName: 'kg_desconto_impureza', dbName: 'kg_desconto_impureza', transform: toNumber },
      { accessName: 'kg_nota', dbName: 'kg_nota', transform: toNumber },
      { accessName: 'sacos_remessa', dbName: 'sacos_remessa', transform: toNumber },
      { accessName: 'sacos_nota', dbName: 'sacos_nota', transform: toNumber },
      { accessName: 'sacos', dbName: 'sacos', transform: toNumber },
      { accessName: 'preco_kg', dbName: 'preco_kg', transform: toNumber },
      { accessName: 'valor_remessa', dbName: 'valor_remessa', transform: toNumber },
      { accessName: 'valor_nota', dbName: 'valor_nota', transform: toNumber },
      { accessName: 'romaneio', dbName: 'romaneio', transform: toInt },
      { accessName: 'motorista', dbName: 'motorista', transform: toStr },
      { accessName: 'motorista_cpf', dbName: 'motorista_cpf', transform: toStr },
