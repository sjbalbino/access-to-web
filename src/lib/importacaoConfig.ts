...
export const tableConfigs: TableConfig[] = [
  ...
  },
  {
    ...
    tableName: 'locais_entrega',
    description: 'Locais de entrega/retirada (sede e terceiros)',
    order: 12,
    columns: [
      { accessName: 'codigo', dbName: 'codigo', transform: toStr },
      { accessName: 'nome', dbName: 'nome', required: true, transform: toStr },
      ...
      { accessName: 'observacoes', dbName: 'observacoes', transform: toStr },
      { accessName: 'ativo', dbName: 'ativo', transform: toBool },
      { accessName: 'is_sede', dbName: 'is_sede', transform: toBool },
    ],
    references: [
      { dbColumn: 'granja_id', sourceColumn: 'granja_codigo', lookupTable: 'granjas', lookupColumn: 'codigo', lookupLabel: 'razao_social', optional: true },
    ],
...
const TENANT_SCOPED_LOOKUP_TABLES = new Set([
  ...
  'contratos_venda','remessas_venda','contas_pagar', 'contas_receber'
]);
