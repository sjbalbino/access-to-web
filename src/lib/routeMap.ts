...
export const routeMap: Record<string, RouteInfo> = {
  ...
  "/relatorios/producao": { title: "Relatórios Produção", icon: BarChart3, color: "text-purple-600" },
  "/relatorios/comercial": { title: "Relatórios Comercial", icon: BarChart3, color: "text-purple-600" },
  "/relatorios/financeiro": { title: "Relatórios Financeiros", icon: BarChart3, color: "text-purple-600" },
  "/relatorios-ir": { title: "Relatórios IR (Sócios)", icon: FileText, color: "text-amber-600" },
  ...
  "/controle-paralelo": { title: "Controle Gerencial", icon: ClipboardCheck, color: "text-fuchsia-600" },
  "/controle-paralelo/relatorios": { title: "Relatórios Gerenciais", icon: BarChart3, color: "text-fuchsia-600" },
