...
export default function ContasReceber() {
  ...
  const gerarParcelas = useGerarParcelasReceber();
    ...
    <AppLayout>
      ...
      <GerarParcelasDialog
        ...
        onGerar={async (config) => {
          // No hook de receber o contrato_venda_id é obrigatório por causa da limpeza, 
          // mas aqui estamos fazendo uma geração genérica. 
          // Vamos passar uma string vazia ou nula se não houver.
          ...
          await gerarParcelas.mutateAsync({
            ...
            contrato_venda_id: '', // Gerando parcelas avulsas
          });
        }}
      />
    </AppLayout>
