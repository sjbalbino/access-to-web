...
const GRUPOS: Grupo[] = [
  {
    ...
    cards: [
      ...
      { tipo: "extrato_movimentacao", titulo: "Extrato de Movimentação", descricao: "Livro-razão cronológico por IE",
        detalhe: "Compras, vendas, depósitos, transferências e devoluções em ordem cronológica com saldo corrente por inscrição e resumo geral por local.",
        icon: FileText, iconBg: "bg-indigo-500/10", iconColor: "text-indigo-600", primario: true },
