...
export type DevolucaoInput = Omit<DevolucaoDeposito, 'id' | 'codigo' | 'created_at' | 'updated_at' | 'granja' | 'safra' | 'inscricao_emitente' | 'inscricao_produtor' | 'produto' | 'silo' | 'nota_fiscal'>;
